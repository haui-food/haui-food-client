...
import ListCategories from '~/components/ListCategorise/ListCategorise';
    ...
    <div className={cx('home')}>
      ...
      <div className={cx('container gx-5')}>
          ...
          <div className={cx('home__search-title-container')}>
            ...
            >
              <div className={cx('home__close-container')}>
                <div className={cx('home__remove-tilte')}>{t('home.close-btn')}</div>
        ...
        <h1 className={cx('home__title-1')}>
          {t('home.title01')} <span className={cx('home__title-1--highlight')}>HauiFood</span>
        </h1>
            ...
            <div className={cx('col-md-6 col-12')}>
              <div className={cx('banner-footer__right')}>
                ...
                <div className={cx('banner-footer__logo-container')}>
                  <img src={images.appStore} className={cx('banner-footer__logo')} alt="Haui Food" />
                  <img src={images.googlePlay} className={cx('banner-footer__logo')} alt="Haui Food" />
                </div>
              </div>
            </div>
          </div>
